module.exports = function (RED) {
    ...
    const RUNTIME_PROFILE = "runtime_profile";
    const RUNTIME_PROFILE_TEST = "TEST";
    const RUNTIME_PROFILE_PROD = "PROD";
    ...
    function FlowAsserterInNode(n) {
        ...
        this.on('input', function (msg) {
            ...
            if (node.testId < node.testcases.length) { // testcase remains
                ...
                this.context().global.set(RUNTIME_PROFILE, RUNTIME_PROFILE_TEST);
                ...
                this.context().global.set(RUNTIME_PROFILE, RUNTIME_PROFILE_PROD);
